...
- [x] **Step 1: 在 FtpAdapter.h 添加方法声明**
...
- [x] **Step 2: 在 FtpAdapter.cpp 添加方法实现**
...
- [x] **Step 3: 在 FtpAdapter.cpp 头部添加 include**
...
- [x] **Step 2: 创建 RemoteFileModel.cpp**
...
- [x] **Step 1: 创建 MultiProgressWidget.h**
...
- [x] **Step 2: 创建 MultiProgressWidget.cpp**
...
- [x] **Step 2: 重写 FtpDeployWidget.cpp — setupUi 总框架**
...
- [x] **Step 5: 实现 setupRemotePanel**（核心）
...
- [x] **Step 6: 实现 setupBottomBar、部署逻辑和其余方法**
...
- [x] **Step 1: 在 FtpDeployWidget.h 添加声明**
...
- [x] **Step 2: 在 FtpDeployWidget.cpp 实现拖拽**
...
- [x] **Step 3: 在 setupRemotePanel() 中设置远程面板支持拖放**
...
- [x] **Step 1: 在 CMakeLists.txt 中添加新文件**
...
- [x] **Step 1: 确认 DeployMaster.cpp 中 setupFtpDeployTab 无需改动**
...
- [x] FTP 部署 Tab 显示双栏布局
- [x] 本地文件树正常浏览，路径栏可编辑
- [x] 远程文件面板能加载 FTP 服务器目录内容
- [x] 面包屑导航可点击跳转
- [x] 右键菜单弹出（下载/删除/重命名/新建目录/复制路径）
- [x] 拖拽本地文件到远程面板触发上传
- [x] 多设备进度组件显示
- [x] 部署后远程面板自动刷新

- [x] **Step 3: Commit（如有修改）**
